...
<div class="content">
	<div class="container">
		<div class="p-3 mt-3">
			...
			<a href="{{ url('/admin/input_produk') }}" class="btn btn-sm btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Produk</a><br>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								<a class="btn btn-sm btn-warning" data-toggle="modal" data-target="#myModal{{ $item->produk_id }}"><i class="fa fa-eye" aria-hidden="true"></i></a>
								<a href="/admin/edit_produk/{{$item->produk_id}}" class="btn btn-sm btn-info" onclick="return confirm('Apakah Anda Yakin Akan Mengedit Produk Ini?')"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
								<a href="{{ route('delete_produk', $item->produk_id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Produk Ini?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
