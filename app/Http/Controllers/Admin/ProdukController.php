...
class ProdukController extends Controller
{
    ...
    public function tambah_stok($produk_id){
        $daftar = DB::table('produk')
                ->select('*')
                ->where('produk_id', $produk_id)
                ->first();

        return view('admin.form_stok_produk', compact('daftar'));
    }

    public function simpan_stok_produk(Request $request){
